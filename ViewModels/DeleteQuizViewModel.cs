...
public class DeleteQuizViewModel : BaseViewModel
{
    public ICommand CreateQuizCommand { get; private set; }

    public DeleteQuizViewModel() : base()
    {
    }
    public DeleteQuizViewModel(UserRepository userRepository, INavigationService navigationService, User user) : base(userRepository, navigationService, user)
    {
